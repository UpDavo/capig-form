...
### Ventas
- ventas_2019, ventas_2020, ventas_2021, ventas_2022, ventas_2023, ventas_2024: Ventas anuales. Formato moneda #,##0.00. Vacio si no reporta.
- Los procesos de dashboard leen dinamicamente cualquier columna anual pura de 4 digitos (por ejemplo 2024, 2025, etc.).

### Tamano
- tamano_cod_2022 / tamano_cod_2023 / tamano_cod_2024: Codigo de tamano por ano (1=MICRO, 2=PEQUENA, 3=MEDIANA, 4=GRANDE) cuando exista el ano.
- tamano_2022 / tamano_2023 / tamano_2024: Etiqueta de tamano derivada del codigo cuando exista el ano.
...
- Para cruces y busquedas, el proyecto normaliza RUC removiendo guiones, espacios, comillas y cualquier caracter no numerico.
